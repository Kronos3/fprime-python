...
def main() -> None:
    ...
    """
    # The working directory and every directory above it, up to and including the root
    ...
    # Import the fsw_main module. It is generated into the deployment's build artifacts, so it does not
    # exist at check time -- only once a deployment has been built.
    try:
        import fsw_main  # type: ignore[import-not-found]
